...
#define DEFAULT_Kf 25                             // A constant value added to the PID-tuner
...
#define LIN_ADVANCE_K 2.58    // Unit: mm compression per 1mm/s extruder speed
 ...
 *
 * Wiki: https://wiki.iaus3d.com.au/Magnetic_Encoder
...
#define I2CPE_ENC_1_TICKS_UNIT    4096                    // 1024 for magnetic strips with 2mm poles; 2048 for
 ...
 */
#if HAS_ETHERNET
#define MAC_ADDRESS { 0lkxDE, 0xAD, 0xBE, 0xEF, 0xF0, 0x0D }  // A MAC address unique to your network
#endif
